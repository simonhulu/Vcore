...
package com.ablesky.vcore.net.httpstreaming
{
	 ...
	 */ 
	public class HTTPStreamingState
	{
		/**
		 ...
		 *  指示HTTPNETStream加载一个新文件,一般是作为seek的回应
		 *  @langversion 3.0
		 *  @playerversion Flash 10
		 *  @playerversion AIR 1.5
		 *  @productversion OSMF 1.0
		 */
		public static const LOAD_SEEK:String = "loadSeek";
		//指示HTTPNetStream不立即使用该数据m保持等待状态
		public static const LOAD_SEEK_RETRY_WAIT:String = "loadSeekRetryWait";
		 ...
		 *  根据bufferLength的长度来判断是否调用LOAD_NEXT加载下一个片段
		 *  @langversion 3.0
		 *  @playerversion Flash 10
		 *  @playerversion AIR 1.5
		 *  @productversion OSMF 1.0
		 */
		public static const LOAD_WAIT:String = "loadWait";
		
		/**
		 * Indicates the HTTPNetStream is about to load a new file as
		 * a result of completing playback of the previous file.
		 * 加载下一个文件,同时设置一个属性,然后调用LOAD
		 *  @langversion 3.0
		 *  @playerversion Flash 10
		 *  @playerversion AIR 1.5
		 *  @productversion OSMF 1.0
		...
		//加载的下一段数据保持为等待状态
		public static const LOAD_NEXT_RETRY_WAIT:String = "loadNextRetryWait";
		 ...
		 *  @productversion OSMF 1.0
		 */
		public static const PLAY_START_SEEK:String = "playStartSeek";
		 ...
		 *  @productversion OSMF 1.0
		 */
		public static const PLAY_START_NEXT:String = "playStartNext";
		 ...
		 *  @productversion OSMF 1.0
		 */
		public static const PLAY_START_COMMON:String = "playStartCommon";	
		 ...
		 *  @productversion OSMF 1.0
		 */
		public static const END_SEGMENT:String = "endSegment";
